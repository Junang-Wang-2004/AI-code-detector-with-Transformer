...
class C1(object):
    ...
    def __init__(self, a1, a2=lambda _: float('inf'), a3=lambda x, y: x if y is None else min(x, y), a4=lambda x: x):
...
class C2(object):
    ...
    def longestRepeating(self, a1, a2, a3):
        ...
        def query(a1, a2):
            return a1 if a2 is None else [a1[v1], a2[v2], a1[v3] + (a2[v3] if a1[v3] == a1[v5] and a1[v2] == a2[v1] else 0), a2[v4] + (a1[v4] if a2[v4] == a2[v5] and a2[v1] == a1[v2] else 0), a1[v5] + a2[v5], max(a1[v6], a2[v6], a1[v4] + a2[v3] if a1[v2] == a2[v1] else 0)]
        v8 = []
        v9 = C1(len(a1), build_fn=build, query_fn=query, update_fn=update)
        for v10, v11 in zip(a2, a3):
            v9.update(v11, v10)
            v8.append(v9.tree[1][v6])
        return v8
