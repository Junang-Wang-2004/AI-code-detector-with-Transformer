                ...
                for v10 in range(a2 + 1):
                    for v11 in range(a1 + 1):
                        ...
                        for v13 in range(v11 + 1):
                            ...
                            if v15 > a2:
                                continue
                            v8[v14][v15][v16] = (v8[v14][v15][v16] + v6[v9][v10][v11] * v12 * v4[v13]) % v1
                            v12 = v12 * v7 % v1
            v6 = v8
        return reduce(lambda accu, x: (accu + v7) % v1, (v6[v9][a2 - popcount(v9)][0] for v9 in range(a1 + 1) if a2 - popcount(v9) >= 0), 0) * v2[a1] % v1
